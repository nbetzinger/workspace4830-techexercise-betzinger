...
//Typical ServletHibernate
@WebServlet("/MyServletHibernateDBBetzinger")
public class MyServletHibernateDBBetzinger extends HttpServlet implements Info {
   private static final long serialVersionUID = 1L;

   public MyServletHibernateDBBetzinger() {
      super();
   }
